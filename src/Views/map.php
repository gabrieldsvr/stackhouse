            ...
            success: function (data) {
                ...
                dados.forEach(function (obj,index) {
                    ...
                    imovelFeature.properties = {
                        'description' :  '<img class="card-img-top" src="'+imovelFeature.imo_json.imagem_destaque+'" alt="Card Image"><hr><div><h6>R$ '+imovelFeature.imo_json.valor+'</h6><br>Single Family Residence<br>8936 PRAGUE Way<br>KISSIMMEE, FL 34747<br>' + imovelFeature.imo_json.caracteristicas.cama + ' Quartos ' + imovelFeature.imo_json.caracteristicas.banheiro + ' banheiros </br> ' + imovelFeature.imo_json.caracteristicas.garagem + ' Vagas ' + imovelFeature.imo_json.caracteristicas.area + ' m²</div><br><a href="<?=url_pesquisa("propriedade/1")?>" class="btn btn-sm btn-primary"> Detalhes</a'
                    };
